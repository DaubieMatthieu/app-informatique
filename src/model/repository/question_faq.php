...
/**
 * Recherche une question de FAQ en fonction des paramètres
 * @param PDO $bdd
 * @param array $params
 * @return array
 */
function getQuestionByParams(PDO $bdd, array $params){
    $where = "";
    ...
    $query = $bdd->prepare('SELECT * FROM question_faq WHERE ' . $where);
