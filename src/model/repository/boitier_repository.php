...
/**
 * Recherche un boitier en fonction des paramètres
 * @param PDO $bdd
 * @param array $params
 * @return array
 */
function getBoitierByParams(PDO $bdd, array $params){
    $where = "";
    ...
    $query = $bdd->prepare('SELECT * FROM boitier_capteur WHERE ' . $where);
