...
/**
 * Recherche une inscription en fonction des paramètres
 * @param PDO $bdd
 * @param array $params
 * @return array
 */
function getInscriptionByParams(PDO $bdd, array $params){
    $where = "";
    ...
    $query = $bdd->prepare('SELECT * FROM inscription WHERE ' . $where);
