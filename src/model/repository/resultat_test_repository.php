...
/**
 * Recherche un résultat de test en fonction des paramètres
 * @param PDO $bdd
 * @param array $params
 * @return array
 */
function getResultatByParams(PDO $bdd, array $params){
    $where = "";
    ...
    $query = $bdd->prepare('SELECT * FROM resultat_test WHERE ' . $where);
