...
try {
  ...
  header('Location:../view/autre/Forum.php?success=delete_subject'); //données mise à jour
  exit;
}
catch(Exception $e)
{
  header('Location:../view/autre/Forum.php?error=2.1'); //echec de la maj des données
  exit;
}
